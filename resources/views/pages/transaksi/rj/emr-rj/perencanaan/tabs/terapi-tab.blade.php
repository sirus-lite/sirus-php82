    ...
    @role(['Dokter', 'Admin'])
        @if (!$isFormLocked)
            <x-outline-button type="button" class="justify-center w-full" wire:click.prevent="openModalEresepRJ"
                ...
                <span wire:loading.remove wire:target="openModalEresepRJ" class="inline-flex items-center gap-2">
                ...
                <span wire:loading wire:target="openModalEresepRJ" class="inline-flex items-center gap-2">
                    <x-loading /> Memuat...
                </span>
            </x-outline-button>
        @endif
